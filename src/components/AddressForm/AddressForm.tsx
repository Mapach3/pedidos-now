...
import {Locations,LocationsEnumLabels} from "../../enums/Locations";
  ...
  const AddressForm: React.FC = () => {
    ...
    const handleSubmit = async (e: any) => {
      e.preventDefault();
      console.log({ alias, calle, numeroPuerta, contraseña, ciudad, barrio,telefono });
      try {
    ...
    return (
      <Container component="main" maxWidth="sm" style={{ paddingBottom: "4rem",marginBottom:"4rem",justifyContent:"flex-start" }}>
        <Typography
          variant="h6"
          style={{
            textAlign: "center",
